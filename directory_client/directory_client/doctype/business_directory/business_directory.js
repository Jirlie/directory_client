...
frappe.ui.form.on('Business Directory', {
	refresh: function(frm) {
		frm.add_custom_button(__('Send to Directory'), function(){
			fetch('https://jirlie.com/api/method/directory.api.directory', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ 
			...
			picture_1 : `${webSite}${picOne}`,
			picture_2 : `${webSite}${picTwo}`,
			picture_3 : `${webSite}${picThree}`,
